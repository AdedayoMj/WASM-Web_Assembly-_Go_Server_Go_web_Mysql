...
// ShigaHTMLHeader is the HTML skeletal framework head section of the standard HTML structure that serves as an email content
const ShigaHTMLHeader = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
// ShigaHTMLFooter is the HTML skeletal framework footer section of the standard HTML structure that serves as an email content
const ShigaHTMLFooter = `<table class="module" role="module" data-type="spacer"
